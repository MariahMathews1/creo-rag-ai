...
const categories = ["identity","controller","axis_limits","spindle","feed_and_motion","tooling","workholding","programming","capabilities","safety_and_setup"];
